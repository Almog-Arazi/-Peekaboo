    ...
    if not results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            if gaze_direction != "Looking The mirror":
                ...
                if elapsed_time > 10 and nudge_count < 2:
                    cv2.putText(img, f"Not looking at mirror for 10 sec ({int(elapsed_time)} sec)", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    mirror.nudge()
                    nudge_count += 1
                cv2.putText(img, f"Elapsed time: {int(elapsed_time)} sec", (50, img_h - 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            else:
